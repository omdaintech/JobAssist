 ...
 * Provides navigation and layout structure for school admin pages
 */
...
const SchoolLayout: React.FC = () => {
  const { schoolAdmin, logout } = useSchoolAuth();
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3v2m0 14v2" />
        </svg>
      ),
    },
    {
              ...
              <div className="ml-3 relative">
                <div className="flex items-center space-x-4">
                  <span className="text-sm text-gray-700">
                    {schoolAdmin?.name || schoolAdmin?.email}
                  </span>
                  <button
                ...
                <div className="flex-shrink-0">
                  <div className="h-8 w-8 bg-gray-300 rounded-full flex items-center justify-center">
                    <span className="text-sm font-medium text-gray-700">
                      {schoolAdmin?.name?.charAt(0) || schoolAdmin?.email?.charAt(0)}
                    </span>
                  </div>
                </div>
                <div className="ml-3">
